    ...
    <div>
      ...
      <section className="services" id="services">
        ...
        <div className="services-grid">
          {/* Tax Service */}
          <div className="service-card expandable" id="tax" data-service="tax">
          ...
          {/* Visa Service */}
          <div className="service-card expandable" id="visa" data-service="visa">
            <div className="service-icon">
          ...
          {/* Medical Service */}
          <div className="service-card expandable" id="medical" data-service="medical">
            <div className="service-icon">
          ...
          {/* Labor Service */}
          <div className="service-card expandable" id="labor" data-service="labor">
            <div className="service-icon">
